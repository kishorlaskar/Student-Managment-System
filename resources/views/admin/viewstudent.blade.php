                ...
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                      ...
                      <span style="font-family: sans-serif; font-size:15px;">
                      	{{convert_depertment($student_description_profile->student_depertment)}}</span>
                    </a>
                    <a class="social-link" href="#">
                      <i class="icon-social-linkedin icon">Address:</i>
                      <span style="font-family: sans-serif; font-size:15px;">{{$student_description_profile->student_address}}</span>
                    </a>
                     <a class="social-link" href="#">
                      <i class="icon-social-linkedin icon">Father Name:</i>
                      <span style="font-family: sans-serif; font-size:15px;">{{$student_description_profile->student_fathername}}</span>
                    </a>
                                        
                    <a class="social-link" href="#">
                      <i class="icon-social-facebook icon">Mother Name:</i>
                      <span style="font-family: sans-serif; font-size:15px;">{{$student_description_profile->student_mothername}}</span>
                    </a>

                    <a class="social-link" href="#">
                      <i class="icon-social-linkedin icon">Phone:</i>
                      <span style="font-family: sans-serif; font-size:15px;">{{$student_description_profile->student_phone}}</span>
                    </a>
                    <a class="social-link" href="#">
                      <i class="icon-social-linkedin icon">Admission Year:</i>
                      <span style="font-family: sans-serif; font-size:15px;">{{$student_description_profile->admission_year}}</span>
                    </a>
