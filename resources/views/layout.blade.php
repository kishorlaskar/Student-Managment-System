  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/admin_dashboard')}}"><img src="edu.png" height="90px" width="20px" alt="MIU">MIU
        </a>
      </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="generalSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/tutionfee')}}">
                      Tution Fee
                    </a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="uiPopupSubmenu">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/Buisness')}}">Buisness and Enterprenurship</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/Hotel')}}">Hotel and Tourism Managment</a>
                  </li>
                   <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/ETE')}}">ETE</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/civil')}}">Civil Engineering</a>
                  </li>
                  <li class="nav-item">
